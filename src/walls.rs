// Ripped Wholesale from https://github.com/Trouv/bevy_ecs_ldtk/blob/main/examples/platformer/walls.rs
        ...
        level_query.iter().for_each(|(level_entity, level_iid)| {
            if let Some(level_walls) = level_to_wall_locations.get(&level_entity) {
                let ldtk_project = ldtk_project_assets
                    ...
                    .expect("No project found for handle");
                ...
                info!(
                    "Spawning wall collisions for level {} (width: {}, height: {}, grid_size: {})",
                    level_iid, width, height, grid_size
                );
